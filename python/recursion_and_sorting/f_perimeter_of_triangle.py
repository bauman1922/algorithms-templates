...
def get_perimeter(array):
    array = sorted(array)[::-1]
    for x in range(len(array) - 1):
        if array[x] < array[x + 1] + array[x + 2]:
            return array[x] + array[x + 1] + array[x + 2]
